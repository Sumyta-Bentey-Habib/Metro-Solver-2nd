...
const Logo = ({ collapsed }) => (
  ...
  >
    ...
    {!collapsed && (
      <span className="text-lg font-semibold text-gray-800">METRO SOLVE</span>
    )}
  </div>
);
...
const SideBar = () => {
  ...
  return (
    <div
      className={`h-screen border-r border-gray-200 flex flex-col transition-all duration-300 bg-white ${
        collapsed ? "w-20" : "w-64"
      }`}
    >
      {/* Logo Section */}
      <div className="relative">
        ...
        <button
          ...
          className="absolute -right-3 top-6 bg-indigo-500 text-white p-1 rounded-full shadow-md hover:bg-indigo-600 transition"
        >
